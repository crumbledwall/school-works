...
asmlinkage long sys_mytaskmm(pid_t pid, void __user * my_mm_struct);
asmlinkage long sys_mytaskinfo(pid_t pid, void __user * task_name, void __user *task_state, void __user * task_uid, void __user * task_euid);
